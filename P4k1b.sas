...
title 'Summary of Paylist Table';
select sum(Salary) as totalSalary format=dollar8.,
		avg(Salary) as meanSalary format=dollar8.,
		std(Salary) as StdDevSalary format=dollar8.,
		var(Salary) as varianceSalary format=dollar9.
      from paylist;
