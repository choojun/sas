...
[P6a2.sas](https://github.com/choojun/sas/blob/main/P6a2.sas) How to use arithmetic operators

[P6a3.sas](https://github.com/choojun/sas/blob/main/P6a3.sas) How to use logical operators

[P6a4.sas](https://github.com/choojun/sas/blob/main/P6a4.sas) How to use comparison operators

[P6a5.sas](https://github.com/choojun/sas/blob/main/P6a5.sas) How to use mathematic-based functions

[P6a6.sas](https://github.com/choojun/sas/blob/main/P6a6.sas) How to use concatenation operator

[P6a7.sas](https://github.com/choojun/sas/blob/main/P6a7.sas) How to use dash (-) operators

[P6a8.sas](https://github.com/choojun/sas/blob/main/P6a8.sas) How to use colon (:) operator

[P6a9.sas](https://github.com/choojun/sas/blob/main/P6a9.sas) How to use PROC MEANS

[P6b1.sas](https://github.com/choojun/sas/blob/main/P6b1.sas) How to use character-based functions

[P6b2.sas](https://github.com/choojun/sas/blob/main/P6b2.sas) How to use date and time-based functions

[P6b3.sas](https://github.com/choojun/sas/blob/main/P6b3.sas) How to use statistical-based functions

[P6b4.sas](https://github.com/choojun/sas/blob/main/P6b4.sas) How to use numeric-based functions

[P6b5.sas](https://github.com/choojun/sas/blob/main/P6b5.sas) How to handle missing data with COALESCE and COALESCEC
...
3. Collect and prepare data by gathering the relevant data, and then organize it in a suitable format for analysis. Ensure that your data meets the assumptions of the selected test.
 
4. Perform the test and compute the P-value as well as related metrics, which is the probability that a test statistic at least as significant as the one observed would be obtained assuming that the null hypothesis were true. 

5. Interpret the test results by examining the generated output, and then interpret the results of the test.

6. Based on the results and the significance level (alpha) you have set in advance. Make a decision to either reject or fail to reject the null hypothesis. For example, the smaller the P-value, the stronger the evidence against the null hypothesis. Compare the p-value to an acceptable significance value alpha (sometimes called an alpha value). Suppose p <= alpha, that the observed effect is statistically significant, the null hypothesis is ruled out, and the alternative hypothesis is valid.
...
Hints: PROC TTEST with SAS programming
...
[P10c3.sas](https://github.com/choojun/sas/blob/main/P10c3.sas) How to use PROC TEMPLATE and PROC SGRENDER to create grouped discrete-based scatter plot

[P10c4.sas](https://github.com/choojun/sas/blob/main/P10c4.sas) How to use PROC TEMPLATE and PROC SGRENDER to create dot plot discrete-based scatter plot

[P10c5.sas](https://github.com/choojun/sas/blob/main/P10c5.sas) How to use PROC SGSCATTER to create scatter plot

[P10c6.sas](https://github.com/choojun/sas/blob/main/P10c6.sas) How to use PROC SGSCATTER to create multiple independent scatter plots and spline curves

[P10c7.sas](https://github.com/choojun/sas/blob/main/P10c7.sas) How to use PROC SGSCATTER to create comparative panel with scatter plots

[P10c8.sas](https://github.com/choojun/sas/blob/main/P10c8.sas) How to use PROC SGSCATTER to create comparative panel with regression fit and confidence ellipse in scatter plots
...
#### A. Knapsack problem
Named after the classic packing problem, the [knapsack problem](https://en.wikipedia.org/wiki/Knapsack_problem) arises when limited resources must be allocated to maximize value. This often occurs in decision-making where choices are made from a set of indivisible options under constraints like budget or time.

[P12a1.sas](https://github.com/choojun/sas/blob/main/P12a1.sas) How to use PROC IML with MILPSOLVE to tackle a binary-based knapsack problem.

[Genetic algorithms (GAs)](https://en.wikipedia.org/wiki/Genetic_algorithm) are a computational technique, which is a metaheuristic inspired by the process of natural selection that belongs to the larger class of [evolutionary algorithms](https://en.wikipedia.org/wiki/Evolutionary_algorithm). They use biological concepts like genes, chromosomes, and fitness to create and improve solutions to [optimisation problems](https://en.wikipedia.org/wiki/Optimization_problem). The [pseudocode](https://en.wikipedia.org/wiki/Pseudocode) of GA is:
...
We are using a GA to solve the knapsack problem, which involves maximizing the value of selected items while adhering to given constraints such as weight limits, budget allocations, and time intervals.

[P12a2.sas](https://github.com/choojun/sas/blob/main/P12a2.sas) How to use PROC IML to resolve knapsack problem with GA

[P12a3.sas](https://github.com/choojun/sas/blob/main/P12a3.sas) How to use PROC IML a binary chromosome to perform mutation operation of GA.

[P12a4.sas](https://github.com/choojun/sas/blob/main/P12a4.sas) How to use PROC IML a binary chromosome to perform mutation and crossover operations of GA.
